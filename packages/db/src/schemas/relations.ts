...
import {
  ...
  s3_multipart_uploads_partsInStorage,
  s3_multipart_uploadsInStorage,
...
export const bucketsInStorageRelations = relations(
  ...
  ({ many }) => ({
    ...
    s3_multipart_uploads_partsInStorages: many(
      s3_multipart_uploads_partsInStorage,
    ),
  }),
);
...
export const refresh_tokensInAuthRelations = relations(
  refresh_tokensInAuth,
  ({ one }) => ({
...
export const mfa_factorsInAuthRelations = relations(
  mfa_factorsInAuth,
  ({ one, many }) => ({
    usersInAuth: one(usersInAuth, {
...
export const mfa_challengesInAuthRelations = relations(
  mfa_challengesInAuth,
  ({ one }) => ({
...
export const mfa_amr_claimsInAuthRelations = relations(
  mfa_amr_claimsInAuth,
  ({ one }) => ({
    sessionsInAuth: one(sessionsInAuth, {
...
export const sso_domainsInAuthRelations = relations(
  sso_domainsInAuth,
  ({ one }) => ({
...
export const sso_providersInAuthRelations = relations(
  sso_providersInAuth,
  ({ many }) => ({
...
export const saml_relay_statesInAuthRelations = relations(
  saml_relay_statesInAuth,
  ({ one }) => ({
...
export const flow_stateInAuthRelations = relations(
  flow_stateInAuth,
  ({ many }) => ({
    saml_relay_statesInAuths: many(saml_relay_statesInAuth),
  }),
...
export const saml_providersInAuthRelations = relations(
  saml_providersInAuth,
  ({ one }) => ({
    sso_providersInAuth: one(sso_providersInAuth, {
...
export const one_time_tokensInAuthRelations = relations(
  one_time_tokensInAuth,
  ({ one }) => ({
    usersInAuth: one(usersInAuth, {
...
export const s3_multipart_uploadsInStorageRelations = relations(
  s3_multipart_uploadsInStorage,
  ({ one, many }) => ({
    bucketsInStorage: one(bucketsInStorage, {
...
export const s3_multipart_uploads_partsInStorageRelations = relations(
  s3_multipart_uploads_partsInStorage,
  ({ one }) => ({
    bucketsInStorage: one(bucketsInStorage, {
